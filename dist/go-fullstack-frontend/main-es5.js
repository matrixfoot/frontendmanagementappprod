    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function createNewUser(email, password) {
          ...
          return new Promise(function (resolve, reject) {
            _this11.http.post('https://backendmanagementappprod.herokuapp.com/api/auth/signup', {
              email: email,
              password: password
            }).subscribe(function () {
        ...
        value: function login(email, password) {
          ...
          return new Promise(function (resolve, reject) {
            _this12.http.post('https://backendmanagementappprod.herokuapp.com/api/auth/login', {
              email: email,
              password: password
    ...
    var ProjetService = /*#__PURE__*/function () {
      ...
      _createClass(ProjetService, [{
        ...
        value: function getProjet() {
          ...
          this.http.get('https://backendmanagementappprod.herokuapp.com/api/projet').subscribe(function (projet) {
            if (projet) {
        ...
        value: function getProjectById(id) {
          ...
          return new Promise(function (resolve, reject) {
            _this14.http.get('https://backendmanagementappprod.herokuapp.com/api/projet/' + id).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
        ...
        value: function createNewProjectWithFile(project, image) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this15.http.post('https://backendmanagementappprod.herokuapp.com/api/projet', projectData).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
        ...
        value: function modifyProjectWithFile(id, project, image) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            _this16.http.put('https://backendmanagementappprod.herokuapp.com/api/projet/' + id, projectData).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
        ...
        value: function deleteProject(id) {
          ...
          return new Promise(function (resolve, reject) {
            _this17.http["delete"]('https://backendmanagementappprod.herokuapp.com/api/projet/' + id).subscribe(function (response) {
              resolve(response);
            }, function (error) {
              reject(error);
            });
